 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="G5\ProjetBundle\Entity\AnnonceImagesRepository")
 */
class AnnonceImages {
...
//    }
    ...
    public function upload() {
        ...
        $nom = $this->annonce->getAuteur()->getUsername() . "_" . $this->annonce->getId() . '_' . date("YmdHis") . '.' . $this->photo->guessExtension();
