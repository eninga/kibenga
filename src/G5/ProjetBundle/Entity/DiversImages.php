 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="G5\ProjetBundle\Entity\DiversImagesRepository")
 */
class DiversImages {
...
//    }
    ...
    public function upload() {
        ...
        $nom = $this->divers->getAuteur()->getUsername() . "_" . $this->divers->getId() . '_' . date("YmdHis") . '.' . $this->photo->guessExtension();
