 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="G5\ProjetBundle\Entity\ImmobilierImagesRepository")
 */
class ImmobilierImages
{
    /**
     * @var integer
     *
...
//    }
    ...
    public function upload() {
        ...
        $nom = $this->immobilier->getAuteur()->getUsername()."_".$this->immobilier->getId() . '_' . date("YmdHis") . '.' . $this->photo->guessExtension();
